...
(function (app) {
    app.controller('semanticsListController', semanticsListController);
    semanticsListController.$inject = ['$scope', 'apiService', 'notificationService'];
    function semanticsListController($scope, apiService, notificationService) {
