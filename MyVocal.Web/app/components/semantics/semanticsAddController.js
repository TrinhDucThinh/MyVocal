...
(function (app) {
    app.controller('semanticsAddController', semanticsAddController);
    semanticsAddController.$inject = ['apiService','$scope','notificationService','$state'];

    function semanticsAddController(apiService,$scope,notificationService,$state) {
        $scope.wordCategory = {
...
})(angular.module('myvocal.semantics'));