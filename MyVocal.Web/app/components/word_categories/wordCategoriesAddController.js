...
(function (app) {
    app.controller('wordCategoriesAddController', wordCategoriesAddController);
    wordCategoriesAddController.$inject = ['apiService','$scope','notificationService','$state'];

    function wordCategoriesAddController(apiService,$scope,notificationService,$state) {
        $scope.wordCategory = {
